...
namespace RM_EDU
{
    ...
    public abstract class ActionPlayer : MonoBehaviour
    {
        ...
        // Gets set to 'true' if the player is withholding energy from defense units trying to attack.
        // If witholding energy, units that use energy to attack cannot take from the player's energy.
        // If a unit uses no energy for attacking, it can still attack.
        [Tooltip("If true, the player is witholding energy that's used for attacks, preventing defenses that use energy from attacking.")]
        public bool withholdingAttackEnergy = false;
        ...
        public bool HasEnergyForAttack(ActionUnit actionUnit)
        {
            ...
            // If the player with witholding attack energy, act as if...
            // The player has no energy for attacking.
            if(withholdingAttackEnergy)
            {
            ...
            {
                // The player isn't witholding energy for attacks...
