...
namespace RM_EDU
{
    ...
    public abstract class ActionUnit : MonoBehaviour
    {
        ...
        {
            // Ceil(Amount Stat / Stat Maximum * 23.85)
            return Mathf.Ceil(energyGenAmnt / BASE_STAT_MAXIMUM * 23.85F);
        }
        ...
        public virtual float CalculateEnergyGenerationAmount()
        {
            ...
            return CalculateEnergyGenerationAmount(energyGenerationAmount);
        }
        ...
        {
            // Divide by 10, multiply by 4.5 and round up to the nearest value.
            return Mathf.Ceil(attackEnergyCost / 10.0F * 4.5F);
        }
        ...
        {
            // 1.0F + ((BASE_STAT_MAXIMUM - attackSpeed) / BASE_STAT_MAXIMUM * 4.25F)
            return 1.0F + ((attackSpeedMaximum - attackSpeed) / attackSpeedMaximum * 4.25F);
        }
        ...
        {
            return energyDeathCost * statFactor * 1.12F;
        }
