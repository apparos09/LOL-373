    ...
    public class Tutorials : MonoBehaviour
    {
        ...
        public void LoadIntroTutorial(bool startTutorial = true)
        {
            ...
            List<Page> pages = new List<Page>
            {
                ...
                new EDU_Page("This simulation has two stage types: action and knowledge. In action stages you defend a base from enemies and in knowledge stages you're assessed on your knowledge of natural resources. You'll be given more details on both stage types later.", "trl_intro_01", tutorialsUI.textBox.stageTypesSprite),
                new EDU_Page("In the top left is the info log button, which opens the info log. The info log provides information on simulation elements you've encountered.", "trl_intro_02", tutorialsUI.textBox.logButtonSprite),
                new EDU_Page("In the top right is the options button, which opens the options menu. The options menu allows you to save your progress, quit the game, and adjust the game's settings.", "trl_intro_03", tutorialsUI.textBox.optionsButtonSprite),
        ...
        public void LoadFirstActionIntroTutorial(bool startTutorial = true)
        {
            ...
            List<Page> pages = new List<Page>
            {
                ...
                new EDU_Page("To fend off enemies, you place units on the field, which requires energy. The energy needed to create a unit is displayed on its unit button. Some energy is generated automatically, but you'll need to place generator units on the field to generate more energy. Your generator units can be found in the bottom left.", "trl_firstActionIntro_03"),
        ...
        public void LoadFirstActionGeneratorsTutorial(bool startTutorial = true)
        {
            ...
            List<Page> pages = new List<Page>
            {
                ...
                new EDU_Page("In the top left is the info log button, which opens the info log. The info log is the same as it is in the world area. If you ever need information on what your units do, check the info log.", "trl_firstActionGenerators_01", tutorialsUI.textBox.logButtonSprite),
        ...
        public void LoadFirstActionDefensesTutorial(bool startTutorial = true)
        {
            ...
            {
                // Load the pages.
                new EDU_Page("Enemies are approaching! You'll need to use defense units to defeat them. Your defense units can be found in the bottom right. Defense units come in three types: blaster, shield, and trap.", "trl_firstActionDefenses_00", tutorialsUI.textBox.actionDefenseTypesSprite),
                new EDU_Page("Blasters (BSRs) use energy to fire projectiles at enemies, shields (SHDs) block enemies, and traps (TRPs) attack enemies that make contact with them. You'll unlock more defense units naturally as the simulation progresses.", "trl_firstActionDefenses_01", tutorialsUI.textBox.actionDefenseTypesSprite),
        ...
        public void LoadFirstActionFirstKillTutorial(bool startTutorial = true)
        {
            ...
            {
                // Load the pages.
                new EDU_Page("You've defeated your first enemy, but there's still more on the way. Now that you have an idea of how action stages work, there's some more mechanics that you should know about.", "trl_firstActionFirstKill_00"),
        ...
        public void LoadBiomassTutorial(bool startTutorial = true)
        {
            ...
            List<Page> pages = new List<Page>
            {
                ...
                new EDU_Page("A biomass generator can be placed anywhere on land, generates energy regularly, and produces no air pollution. It generates a moderate amount of energy at a slow rate.", "trl_biomass_01", tutorialsUI.textBox.biomassSprite),
            };
