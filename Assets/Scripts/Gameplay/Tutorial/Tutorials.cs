    ...
    public class Tutorials : MonoBehaviour
    {
        ...
        public TutorialInfo GetFirstActionIntroTutorialInfo()
        {
            ...
            List<Page> pages = new List<Page>
            {
                ...
                new EDU_Page(title, titleKey, "When you have a unit selected, it will be displayed in the bottom middle, and spots on the field will be highlighted to show where the unit can be placed. Two units cannot share the same space, and some units can only use certain tiles.", "trl_firstActionIntro_txt_06", tutorialsUI.textBox.actionUnitSelectedSprite),
        ...
        public TutorialInfo GetFirstActionGeneratorsTutorialInfo()
        {
            ...
            List<Page> pages = new List<Page>
            {
                ...
                new EDU_Page(title, titleKey, "In the top right is the options button, which opens the options menu. The options menu allows you to quit the stage, reset the stage, and adjust the game's settings.", "trl_firstActionGenerators_txt_04", tutorialsUI.textBox.optionsButtonSprite),
