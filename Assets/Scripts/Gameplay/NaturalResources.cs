            ...
            else
            {
                ...
                switch (res)
                {
                    ...
                    case naturalResource.wind:
                        ...
                        {
                            result.Add("A renewable resource that uses wind to turn turbines to generate energy. Wind can be harnessed practically anywhere, but no energy can be generated if there's no wind. Wind turbines produce no pollutants but can be expensive and wear out quickly.");
                        }
